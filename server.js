...
app.get("/products", async (req, res) => {
	try {
	  ...
	  if (gebruiker) {
		...
		const query = {
		  $or: [  //er worden meerdere voorwaarden(4) gecombineert. Het resultaat van de zoekopdracht zijn documenten die overeenkomen met ten minste één van deze voorwaarden.
